...
class CentralWidgetStatusBarMixin:
    ...
    def build_central_widget(self):
        ...
        path_label = QLabel(self.tr("Path:"))
        path_layout.addWidget(path_label)
        self.path_edit.setAccessibleName(self.tr("Current folder path"))
        ...
        self.search_edit.setAccessibleName(self.tr("Search inside this folder"))
