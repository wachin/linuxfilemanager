...
class MenuBarMixin:
    ...
    def build_menu_bar(self):
        ...
        self._add_action(file_menu, "Bulk Rename Tree...", self.bulk_rename_tree)
        ...
        self.inline_expansion_action = QAction(self.tr("Expandable Folders"), self, checkable=True)
        self.inline_expansion_action.setChecked(self.config.inline_tree_expansion)
        ...
        self.folder_sizes_action = QAction(self.tr("Show Folder Sizes"), self, checkable=True)
        self.folder_sizes_action.setChecked(self.config.show_folder_sizes)
        self.folder_sizes_action.triggered.connect(self.toggle_folder_sizes)
        view_menu.addAction(self.folder_sizes_action)
        self._register_command_action(self.folder_sizes_action, category=self.tr("View"))
