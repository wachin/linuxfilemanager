...
class OperationCenterMixin:
    ...
    def build_jobs_status_button(self):
        ...
        button.setToolTip(self.tr("Show or hide the operations panel"))
        button.setAccessibleName(self.tr("Operations"))
    ...
    def _add_job_row(self, worker, label: str):
        ...
        bar.setAccessibleName(self.tr("Progress of {label}").format(label=label))
        pause_button = QPushButton(app_icon("media-playback-pause", "media-playback-start"), "", row)
        pause_button.setToolTip(self.tr("Pause"))
        pause_button.setAccessibleName(self.tr("Pause operation"))
        ...
        retry_button.setAccessibleName(self.tr("Retry operation"))
        ...
        cancel_button.setAccessibleName(self.tr("Cancel operation"))
